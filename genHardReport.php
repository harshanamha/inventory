...
<form action="createHardReport.php" method="post" target="_blank">
  <div class="container">
    <h2>Search Hardware details Report</h2>
    <hr>
    ...
    <button type="submit" class="registerbtn">Generate hardware Detail Reprt</button>
  </div>
