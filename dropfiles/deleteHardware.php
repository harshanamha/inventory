...
<hr>
    ...
    <div id = "data" name="data" hidden>

<form action="deleteHardwareReg.php" method="post">
    ...
    <button type="submit" id = "updatebtn" name = "updatebtn" class="registerbtn" >Delete Hardware</button>
  </div>
