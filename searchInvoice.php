...
<form action="createInvoiceReg.php" method="post" id="form" name="form" hidden>
  ...
  <option value="Cheque">Cheque</option>
    ...
    <button type="submit" class="registerbtn"  id = "updatebtn" name = "updatebtn" >Create Sale</button>
	</div>
  </div>
