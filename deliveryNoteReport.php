...
<form action="createDeliveryNoteReport.php" method="post">

<div class="container">
    <h2>Find Delivery Sales</h2>
    ...
    <button type="submit" class="registerbtn"  id = "updatebtn" name = "updatebtn">Create Report</button>
