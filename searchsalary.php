...
<form action="createsearchsalary.php" method="post">
  <div class="container">
    <h2>Type Detail Report</h2>
    <hr>
    ...
    <label for="psw"><b>Employee Name</b></label><br>
    <input type="text" placeholder="Type" name="emp" id="emp" required>
