...
<form action="createDNprofReport.php" method="post" target="_blank">
  <div class="container">
	...
	<label for="psw"><b>Deliver Note No</b></label><br>
        <input type="text" autocomplete="off" placeholder="Deliver Note No" name="dn" id="dn" >
